...
All 16 derived petrophysical indicators (classic and expanded Pixler ratios, TG, Dryness, Carbon density index, Haworth show ratios, GOW, GOW No TG, WBS, GOR, and Zone Classification) are implemented and verified against hand-computed reference values. The majority-vote classification engine is then built on top of the indicator outputs, along with the tie-breaking priority rule.
