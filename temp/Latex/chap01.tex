...
\begin{enumerate}
    \item The product is a lightweight, zero-installation web application that ingests raw mud logging chromatographic gas records ($C_1$ through $nC_5$ and $TG$) across standard tabular and industry formats (\texttt{.csv}, \texttt{.txt}, \texttt{.xlsx}, and \texttt{.las}), automatically isolating numerical data matrices from unstructured rig comments and company headers.
