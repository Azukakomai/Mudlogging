...
\paragraph{8--9. Expanded Pentane Isomer Multipliers:}
Provides heightened resolution for identifying condensate and volatile oil transitions:
\begin{equation}
    \text{Ratio}_{\text{iC5}} = \frac{C_1}{iC_5}, \quad \text{Ratio}_{\text{nC5}} = \frac{C_1}{nC_5}
\end{equation}
...
\begin{equation}
    GOW = (C_3 + iC_4 + nC_4 + iC_5 + nC_5) \times TG, \quad GOW_{\text{noTG}} = \frac{GOW}{TG^2}
\end{equation}
\begin{equation}
