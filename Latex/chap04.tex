...
All 16 derived petrophysical indicators (Pixler ratios, expanded butane/pentane multipliers, TG, Dryness, Carbon density index, Haworth show ratios, GOW, GOW No TG, WBS, and GOR) are implemented and verified against hand-computed reference values. The majority-vote classification engine is then built on top of the indicator outputs, along with the tie-breaking priority rule.
